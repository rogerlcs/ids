...
byte ip[] = { 172, 16, 103, 120 };
byte gateway[] = { 172, 16, 103, 126 };
    ...
    while (client.connected())
    {
      if (client.available())
      {
        ...
        if (c == 'n')
        {
          ...
          client.println("</head>");
          client.println("<body>");
          client.println("<div id='wrapper'><img alt='Automação Residencial' src='https://img.filipeflop.com/files/download/automacao/logoFF.jpg'/><br/>");
          client.println("<div id='div1'>LED 1</div>");
          client.println("<div id='div2'>LED 2</div>");
